...
public class DBRead {
   ...
   public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
	...
	job.setJarByClass(DBRead.class);
	...
	//设置要读取的数据获取方式
	DBInputFormat.setInput(job, StudentDBWritable.class,"SELECT student_id,age, student_name,gender,class_no,pro_id FROM test.student" , "select count(1) from student");
