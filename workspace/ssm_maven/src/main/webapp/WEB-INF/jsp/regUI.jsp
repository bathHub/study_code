...
<link href="${url}/script/css/demos.css" rel="stylesheet" />
...
<body>
	<form action="${url}/user/reg.action" method="post" onsubmit="return check()">
		用户名:<input type="text" name="name" id="name1"/><br>
		密码:<input type="password" name="pwd" id="pwd1"><br>
		确认密码:<input type="password" id="pwd2" onchange="checkPwd(this.value)"><span id="s1"></span><br>
